				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
                            <a href="kelola_menu_profil_nama.php" type="button" class="btn btn-warning btn-xs"><i class="fa fa-info-circle"></i> Ubah Nama</a>
                            <a href="kelola_menu_profil_tambah.php" type="button" class="btn btn-info btn-xs"><i class="lnr lnr-pencil"></i> Tambah</a>
                        </div>
						<div class="panel-body">
