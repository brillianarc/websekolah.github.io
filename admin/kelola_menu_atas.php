...
-->
								<tbody>
									<tr>
										...
										<td>Luna</td>
                                        <td>
                                            <a href="kelola_menu_profil_ubah.php" type="button" class="btn btn-warning btn-xs"><i class="fa fa-info-circle"></i> Ubah</a>
                                            <a href="kelola_menu_profil_ubah.php" type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus</a>
                                        </td>
									</tr>
									<tr>
										<td>2</td>
