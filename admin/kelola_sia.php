			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="kelola_sia.php" class="active"><i class="lnr lnr-text-format"></i> <span>Kelola Sistem Akademik</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Kelola Sistem Akademik</h3>
                            ...
                            <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
								...
								<tbody>
									<tr>
										...
										<td>Luna</td>
                                        <td>
                                            <a href="kelola_sia_pengumuman.php" type="button" class="btn btn-info btn-xs"><i class="fa fa-info-circle"></i> Ubah</a>
                                        </td>
									</tr>
									<tr>
										...
										<td>Alleria</td>
                                        <td>
                                            <a href="kelola_sia_datadiri.php" type="button" class="btn btn-info btn-xs"><i class="fa fa-info-circle"></i> Ubah</a>
                                        </td>
									</tr>
                                    <tr>
										<td>Rencana Studi Siswa</td>
										<td>2011/07/25</td>
										<td>Alleria</td>
                                        <td>
                                            <a href="kelola_sia_datadiri.php" type="button" class="btn btn-info btn-xs"><i class="fa fa-info-circle"></i> Ubah</a>
