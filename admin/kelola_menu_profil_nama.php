				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel-body">
                            <div class="col-md-4">
                                Ubah Nama:
                                <input class="form-control input-xs" placeholder="Ubah Nama" type="text">
                                <br>
                            </div>
                            <div class="col-md-12"></div>
                            <div class="col-md-4">
                            <a href="kelola_menu_profil_ubah.php" type="button" class="btn btn-success btn-xs btn-block"> <i class="fa fa-info-circle"></i> Simpan</a>
                            </div>
                        </div>
                        <br>
					</div>
