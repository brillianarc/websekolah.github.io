				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Kelola Jurusan</h3>
...
-->
								<tbody>
									<tr>
										...
										<td>Matematika-Fisika-Kimia-Biologi</td>
										<td>Admin 1</td>
										<td>2011/04/25</td>
                                        <td>
                                            <a href="kelola_jurusan_ubah.php" type="button" class="btn btn-warning btn-xs"><i class="fa fa-info-circle"></i> Ubah</a>
                                            <a href="kelola_jurusan_ubah.php" type="button" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Hapus</a>
                                        </td>
									</tr>
									<tr>
										<td>IB</td>
										<td>Ilmu Bahasa</td>
										<td>Bhs.Asing-Antropologi-</td>
                                        <td>Admin 1</td>
										<td>2011/07/25</td>
                                        <td>
                                            <a href="kelola_jurusan_ubah.php" type="button" class="btn btn-warning btn-xs"><i class="fa fa-info-circle"></i> Ubah</a>
                                    ...
                                    <tr>
										<td>IS</td>
										<td>Ilmu Sosial</td>
										<td>Ekonomi-Sosiologi-Sejarah-Geografi</td>
                                        <td>Admin 1</td>
										<td>2011/07/25</td>
                                        <td>
