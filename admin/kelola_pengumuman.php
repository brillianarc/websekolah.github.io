			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="kelola_pengumuman.php" class="active"><i class="lnr lnr-code"></i> <span>Kelola Pengumuman</span></a></li>
						...
						<li><a href="kelola_sia.php" class=""><i class="lnr lnr-text-format"></i> <span>Kelola Sistem Akademik</span></a></li>
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Kelola Pengumuman</h3>
